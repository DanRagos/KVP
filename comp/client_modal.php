...
<div class="modal fade modal-lg" id="createClient" data-bs-keyboard="false" tabindex="-1"
    ...
    <div class="modal-dialog modal-dialog-scrollable">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="container">
                    <div class="row">
                        <form id="client-form" action="#" method="POST" enctype="multipart/form-data"
                            autocomplete="off">
                            <div id="regAlert"></div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-3">
                                    <div class="input-group input-group-static my-3">
                                        <input type="file" name="picture" class="form-control" accept="image/jpeg"
                                            required>
            ...
            <div class="modal-footer">
                <button type="submit" class="btn btn-primary" name="clientRegisterBtn"
                    id="client-register-btn">Confirm</button>
...
<div class="modal fade modal-lg" id="editClient" data-bs-keyboard="false" tabindex="-1" aria-labelledby="title"
    aria-hidden="true">
    <div class="modal-dialog modal-dialog-scrollable">
        <div class="modal-content">
            <div class="modal-header">
...
<div class="col-md-4">
    <div class="modal fade" id="deleteUser" tabindex="-1" role="dialog" aria-labelledby="modal-notification"
        aria-hidden="true">
        <div class="modal-dialog modal-danger modal-dialog-centered modal-" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h6 class="modal-title font-weight-normal" id="modal-title-notification">Your attention is required
                    </h6>
...
<!-- Adding Contract -->
<div class="modal fade modal-lg" id="addContract" data-bs-keyboard="false" tabindex="-1" aria-labelledby="title"
    aria-hidden="true">
    <div class="modal-dialog modal-dialog-scrollable">
        <div class="modal-content">
            <div class="modal-header">
	...
	?>
                                        <option value="<?php echo $row['machine_id']?>">
                                            <?php echo $row['machine_name']?></option>
                                        <?php } ?>
                                    </select>
                                </div>
                            </div>
            ...
            <div class="modal-footer">
                <button type="button" id="detailsModal" class="btn btn-primary" data-bs-toggle="modal"
            ...
            <div class="modal-body p-0">
                <div class="card card-plain">
                    <div class="responsive card-header pb-0 text-left">
                        ...
                        <center>
                            <h6 class="">Add Schedule for Service Call</h6>
                        </center>


                    </div>
                    <div class="card-body">
                        <form role="form text-left" action="../inc/save_service_call.php" method="post"
                            autocomplete="off">
                            ...
                            <div class="input-group input-group-static mb-4">
                                <input type="text" id="other" name="client_name" class="form-control"
                                    placeholder="Client Name / Client Address" autocomplete="off" disabled required>
                                <label class="ms-0">Machine Type</label>
                            ...
                            <div class="text-center">
                                <button type="submit" name="add_sched"
...
<div class="modal fade" id="confirmModal" tabindex="-1" aria-labelledby="confirmModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="confirmModalLabel">Confirm Contract Details</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                    ...
                    <table class="table align-items-center justify-content-center">
                        <thead>
                            <tr>
                                ...
                                <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Turn
                                    Over / Coverage Date</th>
                                <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Parts
                                    Warranty</th>
                                <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">First
                                    PMS Date</th>
                                <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">
                                    Frequency</th>
                                <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">
                                    Contract Type</th>
                                <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">PMS
                                    Count</th>
                                <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">SV
                                    Count</th>
                            </tr>
                        </thead>
                            ...
                            <tr class="">
                                <td>
                                    <div class="d-flex flex-column justify-content-center">
                                        <h6 class="mb-0 text-sm" id="confirmMachine"></h6>
                                        <p class="text-xs text-secondary mb-0"></p>
                                    </div>
                                </td>
                                <td><span class="badge badge-sm bg-gradient-primary" id="confirmTurnOver"></span> </td>
                                <td><span class="badge badge-sm bg-gradient-info" id="confirmParts"></span> </td>
                                <td><span class="badge badge-sm bg-gradient-success" id="confirmFirst"></span> </td>
                                <td><span class="badge badge-sm bg-gradient-primary" id="confirmFrequency"></span> </td>
                                <td><span class="badge badge-sm bg-gradient-info" id="confirmContract"></span> </td>
                                <td><span class="badge badge-sm bg-gradient-success" id="confirmPms"></span> </td>
                                <td><span class="badge badge-sm bg-gradient-info" id="confirmSv"></span> </td>
                            </tr>
                        </tbody>
                    </table>
                </div>
            ...
            <div class="modal-footer">
                <button type="button" id="add-contract-btn" class="btn btn-primary">Confirm</button>
                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
