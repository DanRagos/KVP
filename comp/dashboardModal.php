<!-- Delayed SV -->
<div class="modal fade" id="pendingSv" tabindex="-1" aria-labelledby="pendingModalLbl" aria-hidden="true">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="pendingModalLbl">Delayed SV</h5>
      ...
      <table id="pendSvTable" class="table align-items-center justify-content-center" >
        <thead>
                  ...
                  <tbody class="pendSvTableContent"> 
</tbody>
    </table>
</div>
      </div>
...
<!--Delayed PM -->
<div class="modal fade" id="pendingPm" tabindex="-1" aria-labelledby="pendingPmLbl" aria-hidden="true">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="pendingPmLbl">Delayed PM</h5>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      <div class="modal-body">
      <div class="table-responsive">
      <table id="pendPmTable" class="table align-items-center justify-content-center" >
        <thead>
                  ...
                  <tbody class="pendPmTableContent"> 
</tbody>
    </table>
</div>
      </div>
