...
if (isset($_GET['action'])&& $_GET['action'] == 'restoreContract'){
	$contract_id = $_GET['contract_id'];
	$restoreContract = $client->restore_contract($contract_id);
...
if (isset($_GET['action'])&& $_GET['action'] == 'reportServiceClient'){
	$result = array();
	$users = $client->showUsers();
