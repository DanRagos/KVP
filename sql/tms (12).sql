...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 20, 2023 at 12:07 AM
...
INSERT INTO `accomplished_schedule` (`id`, `schedule_id`, `accomp_date`, `diagnosis`, `service_don`, `recomm`, `service_by`, `accomp_status`, `withC`) VALUES
(1, 1, '2023-06-23', 'Test', 'None', 'Test', 'Dandan Ragos', 2, 0),
(2, 2, '2023-09-23', 'Test', 'Test', 'Test', 'Dandan Ragos', 2, 0);
...
(49, 'Client Ragos', 'Tanza Cavite', 'Dandan Ragos', 'dandanragos@gmail.com', '../image/uploads/5R (3).jpg'),
(50, 'Testt ', 'Test, Cavite', 'Test Dan', 'test@gmail.com', '../image/uploads/mv santiago.webp'),
(51, 'Client Ragos', 'Tanza, Cavite', 'Dandan Ragos', 'dandanragos@gmai.com', '../image/uploads/mv santiago.webp');
...
(1, 1, 4, 'GE', 'Portable', '1', '2023-06-22', '2024-06-23', '2', 2, 5, 12);
...
(1, 1, 1, 0, '2023-06-22', 2),
(2, 1, 1, 0, '2023-09-23', 2),
(3, 1, 1, 0, '2023-12-23', 0),
(5, 2, 0, 2, '2023-07-11', 0),
(6, 2, 0, 3, '2023-07-11', 0);
...
(2, 1, 1, 0, '', '', 9, 'GE', 'TEst', 'None'),
(3, 1, 1, 0, '', '', 9, 'GE', 'TEst', 'None');
...
--
ALTER TABLE `contract`
  MODIFY `contract_id` int(50) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
